...
int main(){
    ...
    #ifndef TEST2
    {
        ...
        Parser parse_simple("testa.dat");
        vector<Planet> p = parse_simple.getPlanets();
        assert(p.size() == 5);
        //Short test
        for(auto i : p){
            assert(i.getName() == "abc" ||
            i.getName() == "abd" ||
            i.getName() == "bdf" ||
            i.getName() == "dbfe" ||
            i.getName() == "cbc"
    ...
    Parser parse_complex("test.dat");
    p = parse_complex.getPlanets();
    assert(p.size() == 12);
    //Longer test
    for(auto i : p){
...
#ifndef TEST9
{
    ...
    while(!life_found){
        ...
        if(refined.front().getProbability() == 100.0){
            ...
            cout << "There is a very small possibility of this happening. If you see this message more than once in a row, there is something wrong with your code." << endl;
            assert(false);
        }
    }
    cerr << "\n\t========================PASS========================\n" << endl;
...
//####################Your Tests#####################//
//cerr << "\n\tTEST #11: Your Test #1" << endl;

//####################Your Tests#####################//
//cerr << "\n\tTEST #12: Your Test #2" << endl;
